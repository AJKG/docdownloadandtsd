...
public class RpaldaRepository {
    ...
    public List<Object> getDiff() throws Exception {
        ...
        try{
            String sql = "select mig_id, migrated_by, sum_info_id, data_diff, request_date from migration_request where REQUEST_DATE > sysdate-4 and data_diff is not null and migrated_by is not null";
